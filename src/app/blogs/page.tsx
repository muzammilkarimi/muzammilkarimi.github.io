...
const Contact: React.FC = () => {
  return (
    <main className="flex flex-col items-center gap-3 md:gap-0 m-2 md:m-7 mr:4 ml:4 md:mr-12 md:ml-12">
      ...
      <div className="mt-20 px-5 md:px-72  text-left flex justify-start flex-col w-full gap-7">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="font-sans font-medium h-20 bg-gray-100 border-2 border-neutral-300 items-center text-left px-4 flex justify-start rounded-xl text-md">
